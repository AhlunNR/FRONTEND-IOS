  ...
  if (showNameModal) {
    return (
      <div className="min-h-screen bg-[#050505] flex items-center justify-center p-6 font-sans">
        <div className="bg-zinc-900/60 backdrop-blur-xl rounded-3xl border border-zinc-800/50 p-10 w-full max-w-md shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-40 h-40 bg-blue-500/10 blur-[60px] pointer-events-none"></div>
          <h2 className="text-2xl font-extrabold text-white mb-2 relative z-10">Siapa namamu?</h2>
          <p className="text-zinc-400 text-sm mb-8 relative z-10">Nama ini akan tercatat di riwayat kuis.</p>
          <input
            type="text"
            value={nameInput}
            ...
            maxLength={40}
            autoFocus
            className="w-full bg-zinc-800/80 border border-zinc-700/50 rounded-xl px-5 py-4 text-white placeholder:text-zinc-600 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/30 mb-6 relative z-10"
          />
          <button
            onClick={handleNameSubmit}
            className="w-full py-4 bg-blue-600 text-white rounded-xl font-bold active:bg-blue-500 transition-all shadow-[0_0_20px_rgba(37,99,235,0.2)] relative z-10"
          >
            Mulai Kuis
          </button>
        </div>
